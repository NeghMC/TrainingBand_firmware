...
// config tutorial: https://github.com/pellepl/spiffs/wiki/Configure-spiffs#configuration-example
...
#define SPIFFS_COPY_BUFFER_STACK        (32)
#endif
...
#define SPIFFS_CFG_PHYS_ERASE_SZ(ignore)  (1024*32)
#endif
...
#define SPIFFS_CFG_LOG_BLOCK_SZ(ignore)   (1024*32)
#endif
#endif
